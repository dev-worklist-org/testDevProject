...
if (!defined('SERVER_NAME'))    define('SERVER_NAME','dev.kordero.net');
...
if (!defined("WORKLIST_URL"))   define("WORKLIST_URL", "https://dev.kordero.net/worklist/");
...
//Hipchat settings
defineOnce('SLACK_USERNAME', 'highfidelity.slack.com');
// DO NOT PUSH THIS TOKEN, NEED TO EMPTY FIRST   !!!!    
defineOnce('SLACK_TOKEN', 'xoxb-3909758535-HHhfB23SNbCxOm7XBl4GYqPB');
